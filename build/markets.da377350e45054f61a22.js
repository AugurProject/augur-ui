...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_markets_view__ = __webpack_require__(1717);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__selectors_markets_all__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__market_selectors_scalar_share_denomination__ = __webpack_require__(1548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__actions_update_markets_filtered_sorted__ = __webpack_require__(757);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__actions_update_favorites__ = __webpack_require__(534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__actions_load_markets__ = __webpack_require__(1714);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__actions_load_markets_by_topic__ = __webpack_require__(1712);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__actions_load_markets_info__ = __webpack_require__(307);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    loadMarkets: function loadMarkets(branchID) {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__actions_load_markets__["a" /* loadMarkets */])(branchID));
    },
    loadMarketsByTopic: function loadMarketsByTopic(topic, branchID) {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__actions_load_markets_by_topic__["a" /* loadMarketsByTopic */])(topic, branchID));
    },
...
var mergeProps = function mergeProps(stateProps, dispatchProps, ownProps) {
  ...
  return _extends({}, stateProps, dispatchProps, ownProps, {
    loadMarkets: function loadMarkets() {
      return _loadMarkets2(branch.id);
    },
    loadMarketsByTopic: function loadMarketsByTopic(topic) {
      return _loadMarketsByTopic2(topic, branch.id);
    }
  });
};
...
var IObject = __webpack_require__(1523)
  , defined = __webpack_require__(1500);
...
module.exports = !__webpack_require__(1482)(function(){
...
var global    = __webpack_require__(1475)
  , core      = __webpack_require__(1474)
  , ctx       = __webpack_require__(1520)
  , hide      = __webpack_require__(1483)
  , PROTOTYPE = 'prototype';
...
var anObject       = __webpack_require__(1485)
  , IE8_DOM_DEFINE = __webpack_require__(1522)
  , toPrimitive    = __webpack_require__(1512)
  , dP             = Object.defineProperty;

exports.f = __webpack_require__(1478) ? Object.defineProperty : function defineProperty(O, P, Attributes){
  anObject(O);
...
var dP         = __webpack_require__(1481)
  , createDesc = __webpack_require__(1490);
module.exports = __webpack_require__(1478) ? function(object, key, value){
...
var store      = __webpack_require__(1509)('wks')
  , uid        = __webpack_require__(1491)
  , Symbol     = __webpack_require__(1475).Symbol
...
var isObject = __webpack_require__(1486);
module.exports = function(it){
...
var $keys       = __webpack_require__(1527)
  , enumBugKeys = __webpack_require__(1501);
...
var _defineProperty = __webpack_require__(1553);
...
var _setPrototypeOf = __webpack_require__(1556);

var _setPrototypeOf2 = _interopRequireDefault(_setPrototypeOf);

var _create = __webpack_require__(1552);

var _create2 = _interopRequireDefault(_create);

var _typeof2 = __webpack_require__(1518);
...
var anObject    = __webpack_require__(1485)
  , dPs         = __webpack_require__(1579)
  , enumBugKeys = __webpack_require__(1501)
  , IE_PROTO    = __webpack_require__(1508)('IE_PROTO')
...
var createDict = function(){
  ...
  var iframe = __webpack_require__(1521)('iframe')
    , i      = enumBugKeys.length
    , lt     = '<'
    , gt     = '>'
    , iframeDocument;
  iframe.style.display = 'none';
  __webpack_require__(1572).appendChild(iframe);
...
var pIE            = __webpack_require__(1489)
  , createDesc     = __webpack_require__(1490)
  , toIObject      = __webpack_require__(1476)
  , toPrimitive    = __webpack_require__(1512)
  , has            = __webpack_require__(1480)
  , IE8_DOM_DEFINE = __webpack_require__(1522)
  , gOPD           = Object.getOwnPropertyDescriptor;

exports.f = __webpack_require__(1478) ? gOPD : function getOwnPropertyDescriptor(O, P){
  O = toIObject(O);
  P = toPrimitive(P, true);
  if(IE8_DOM_DEFINE)try {
    return gOPD(O, P);
...
var def = __webpack_require__(1481).f
  , has = __webpack_require__(1480)
  , TAG = __webpack_require__(1484)('toStringTag');
...
var shared = __webpack_require__(1509)('keys')
  , uid    = __webpack_require__(1491);
module.exports = function(key){
...
var defined = __webpack_require__(1500);
module.exports = function(it){
...
var global         = __webpack_require__(1475)
  , core           = __webpack_require__(1474)
  , LIBRARY        = __webpack_require__(1503)
  , wksExt         = __webpack_require__(1514)
  , defineProperty = __webpack_require__(1481).f;
...
exports.f = __webpack_require__(1484);
...
var _assign = __webpack_require__(1551);
...
var _iterator = __webpack_require__(1558);

var _iterator2 = _interopRequireDefault(_iterator);

var _symbol = __webpack_require__(1557);
...
var aFunction = __webpack_require__(1568);
...
var isObject = __webpack_require__(1486)
  , document = __webpack_require__(1475).document
...
module.exports = !__webpack_require__(1478) && !__webpack_require__(1482)(function(){
  return Object.defineProperty(__webpack_require__(1521)('div'), 'a', {get: function(){ return 7; }}).a != 7;
});
...
var cof = __webpack_require__(1519);
...
var LIBRARY        = __webpack_require__(1503)
  , $export        = __webpack_require__(1479)
  , redefine       = __webpack_require__(1529)
  , hide           = __webpack_require__(1483)
  , has            = __webpack_require__(1480)
  , Iterators      = __webpack_require__(1502)
  , $iterCreate    = __webpack_require__(1574)
  , setToStringTag = __webpack_require__(1507)
  , getPrototypeOf = __webpack_require__(1526)
  , ITERATOR       = __webpack_require__(1484)('iterator')
...
var $keys      = __webpack_require__(1527)
  , hiddenKeys = __webpack_require__(1501).concat('length', 'prototype');
...
var has         = __webpack_require__(1480)
  , toObject    = __webpack_require__(1511)
  , IE_PROTO    = __webpack_require__(1508)('IE_PROTO')
...
var has          = __webpack_require__(1480)
  , toIObject    = __webpack_require__(1476)
  , arrayIndexOf = __webpack_require__(1570)(false)
  , IE_PROTO     = __webpack_require__(1508)('IE_PROTO');
...
var $export = __webpack_require__(1479)
  , core    = __webpack_require__(1474)
  , fails   = __webpack_require__(1482);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__ = __webpack_require__(1496);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__ = __webpack_require__(1497);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(1499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_get__ = __webpack_require__(1559);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__ = __webpack_require__(1498);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_redux__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_router_dom__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_filter_sort_view__ = __webpack_require__(1543);
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    currentReportingPeriod: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_get_value__["a" /* default */])(state, 'branch.reportPeriod')
  };
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rc_progress__ = __webpack_require__(1601);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_components_bullet__ = __webpack_require__(1539);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_helpers_make_query__ = __webpack_require__(525);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_constants_param_names__ = __webpack_require__(524);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_components_dropdown__ = __webpack_require__(1515);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_helpers_parse_query__ = __webpack_require__(727);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_helpers_make_query__ = __webpack_require__(525);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_is_market_data_open__ = __webpack_require__(532);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_constants_param_names__ = __webpack_require__(524);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_debounce__ = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_constants_param_names__ = __webpack_require__(524);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__filter_market_state__ = __webpack_require__(1541);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sort_market_param__ = __webpack_require__(1544);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__filter_search__ = __webpack_require__(1542);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__helpers_filter_by_market_favorites__ = __webpack_require__(1545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__helpers_filter_by_tags__ = __webpack_require__(1546);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_constants_param_names__ = __webpack_require__(524);
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
module.exports = { "default": __webpack_require__(1567), __esModule: true };
...
var _getPrototypeOf = __webpack_require__(1555);

var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);

var _getOwnPropertyDescriptor = __webpack_require__(1554);
...
module.exports = __webpack_require__(1474).Object.assign;
...
var $Object = __webpack_require__(1474).Object;
...
module.exports = __webpack_require__(1474).Object.getPrototypeOf;
...
module.exports = __webpack_require__(1474).Object.setPrototypeOf;
...
module.exports = __webpack_require__(1474).Symbol;
...
module.exports = __webpack_require__(1514).f('iterator');
...
// false -> Array#indexOf
// true  -> Array#includes
var toIObject = __webpack_require__(1476)
  , toLength  = __webpack_require__(1584)
  , toIndex   = __webpack_require__(1583);
...
var getKeys = __webpack_require__(1487)
  , gOPS    = __webpack_require__(1506)
  , pIE     = __webpack_require__(1489);
module.exports = function(it){
...
module.exports = __webpack_require__(1475).document && document.documentElement;
...
var create         = __webpack_require__(1504)
  , descriptor     = __webpack_require__(1490)
  , setToStringTag = __webpack_require__(1507)
  , IteratorPrototype = {};

// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(1483)(IteratorPrototype, __webpack_require__(1484)('iterator'), function(){ return this; });
...
var META     = __webpack_require__(1491)('meta')
  , isObject = __webpack_require__(1486)
  , has      = __webpack_require__(1480)
  , setDesc  = __webpack_require__(1481).f
  , id       = 0;
var isExtensible = Object.isExtensible || function(){
  return true;
};
var FREEZE = !__webpack_require__(1482)(function(){
...
var getKeys  = __webpack_require__(1487)
  ...
  , pIE      = __webpack_require__(1489)
  , toObject = __webpack_require__(1511)
  , IObject  = __webpack_require__(1523)
  , $assign  = Object.assign;

// should work with symbols and should have deterministic property order (V8 bug)
module.exports = !$assign || __webpack_require__(1482)(function(){
  var A = {}
    , B = {}
    , S = Symbol()
...
var dP       = __webpack_require__(1481)
  , anObject = __webpack_require__(1485)
  , getKeys  = __webpack_require__(1487);

module.exports = __webpack_require__(1478) ? Object.defineProperties : function defineProperties(O, Properties){
  anObject(O);
...
var toIObject = __webpack_require__(1476)
  , gOPN      = __webpack_require__(1525).f
  , toString  = {}.toString;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(1520)(Function.call, __webpack_require__(1505).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var toInteger = __webpack_require__(1510)
  , defined   = __webpack_require__(1500);
// true  -> String#at
...
var addToUnscopables = __webpack_require__(1569)
  , step             = __webpack_require__(1575)
  , Iterators        = __webpack_require__(1502)
  , toIObject        = __webpack_require__(1476);
...
module.exports = __webpack_require__(1524)(Array, 'Array', function(iterated, kind){
...
$export($export.S + $export.F, 'Object', {assign: __webpack_require__(1578)});
...
var $export = __webpack_require__(1479)
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
$export($export.S, 'Object', {create: __webpack_require__(1504)});
...
$export($export.S + $export.F * !__webpack_require__(1478), 'Object', {defineProperty: __webpack_require__(1481).f});
...
var toIObject                 = __webpack_require__(1476)
  , $getOwnPropertyDescriptor = __webpack_require__(1505).f;

__webpack_require__(1528)('getOwnPropertyDescriptor', function(){
...
var toObject        = __webpack_require__(1511)
  , $getPrototypeOf = __webpack_require__(1526);

__webpack_require__(1528)('getPrototypeOf', function(){
...
var $export = __webpack_require__(1479);
$export($export.S, 'Object', {setPrototypeOf: __webpack_require__(1581).set});
...
var $at  = __webpack_require__(1582)(true);

// 21.1.3.27 String.prototype[@@iterator]()
__webpack_require__(1524)(String, 'String', function(iterated){
...
var global         = __webpack_require__(1475)
  , has            = __webpack_require__(1480)
  , DESCRIPTORS    = __webpack_require__(1478)
  , $export        = __webpack_require__(1479)
  , redefine       = __webpack_require__(1529)
  , META           = __webpack_require__(1577).KEY
  , $fails         = __webpack_require__(1482)
  , shared         = __webpack_require__(1509)
  , setToStringTag = __webpack_require__(1507)
  , uid            = __webpack_require__(1491)
  , wks            = __webpack_require__(1484)
  , wksExt         = __webpack_require__(1514)
  , wksDefine      = __webpack_require__(1513)
  , keyOf          = __webpack_require__(1576)
  , enumKeys       = __webpack_require__(1571)
  , isArray        = __webpack_require__(1573)
  , anObject       = __webpack_require__(1485)
  , toIObject      = __webpack_require__(1476)
  , toPrimitive    = __webpack_require__(1512)
  , createDesc     = __webpack_require__(1490)
  , _create        = __webpack_require__(1504)
  , gOPNExt        = __webpack_require__(1580)
  , $GOPD          = __webpack_require__(1505)
  , $DP            = __webpack_require__(1481)
  , $keys          = __webpack_require__(1487)
  , gOPD           = $GOPD.f
  , dP             = $DP.f
  , gOPN           = gOPNExt.f
...
if(!USE_NATIVE){
  ...
  $DP.f   = $defineProperty;
  __webpack_require__(1525).f = gOPNExt.f = $getOwnPropertyNames;
  __webpack_require__(1489).f  = $propertyIsEnumerable;
  __webpack_require__(1506).f = $getOwnPropertySymbols;

  if(DESCRIPTORS && !__webpack_require__(1503)){
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(1483)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
__webpack_require__(1513)('asyncIterator');
...
__webpack_require__(1513)('observable');
...
var global        = __webpack_require__(1475)
  , hide          = __webpack_require__(1483)
  , Iterators     = __webpack_require__(1502)
  , TO_STRING_TAG = __webpack_require__(1484)('toStringTag');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(1516);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__(1517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck__ = __webpack_require__(1496);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass__ = __webpack_require__(1497);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(1499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits__ = __webpack_require__(1498);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__enhancer__ = __webpack_require__(1530);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__types__ = __webpack_require__(1531);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__enhancer__ = __webpack_require__(1530);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__types__ = __webpack_require__(1531);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Line__ = __webpack_require__(1600);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Circle__ = __webpack_require__(1599);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_classnames__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__market_basics__ = __webpack_require__(1617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__market_preview_outcomes__ = __webpack_require__(1705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_helpers_make_path__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_helpers_make_query__ = __webpack_require__(525);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_augurjs__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__topics_actions_update_has_loaded_topic__ = __webpack_require__(761);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__load_markets_info__ = __webpack_require__(307);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var loadMarketsByTopic = function loadMarketsByTopic(topic, branchID) {
  return function (dispatch, getState) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__services_augurjs__["b" /* augur */].topics.findMarketsWithTopic({ topic: topic, branchID: branchID }, function (err, marketIDs) {
      if (err) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_actions_update_connection__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__update_has_loaded_markets__ = __webpack_require__(744);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__update_markets_data__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_is_object__ = __webpack_require__(746);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_log_error__ = __webpack_require__(31);
...
var loadMarketsFromAugurNode = function loadMarketsFromAugurNode(branchID) {
  ...
  return function (dispatch, getState) {
    ...
    xhttp.onreadystatechange = function () {
      if (xhttp.readyState === 4 && xhttp.status === 200) {
        var marketsData = JSON.parse(xhttp.responseText);
        if (marketsData == null) {
          dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__update_has_loaded_markets__["a" /* updateHasLoadedMarkets */])(false));
          dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__app_actions_update_connection__["a" /* updateAugurNodeConnectionStatus */])(false));
          callback('loadMarketsFromAugurNode: no markets data returned');
        } else if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils_is_object__["a" /* default */])(marketsData) && Object.keys(marketsData).length) {
          dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__update_markets_data__["a" /* updateMarketsData */])(marketsData));
...
/* harmony default export */ __webpack_exports__["a"] = (loadMarketsFromAugurNode);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return loadMarkets; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_augurjs__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__update_has_loaded_markets__ = __webpack_require__(744);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__update_markets_data__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__load_markets_from_augur_node__ = __webpack_require__(1713);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_is_object__ = __webpack_require__(746);
...
var loadMarkets = function loadMarkets(branchID) {
  return function (dispatch, getState) {
    console.log('loadMarkets -- ', branchID);

    var _getState = getState(),
        connection = _getState.connection,
        env = _getState.env;
    ...
    if (connection.isConnectedToAugurNode) {
      dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__load_markets_from_augur_node__["a" /* default */])(branchID));
    } else {
      __WEBPACK_IMPORTED_MODULE_0__services_augurjs__["b" /* augur */].markets.loadMarkets({
        branchID: branchID,
        chunkSize: 10,
        isDesc: true,
        loadZeroVolumeMarkets: env.loadZeroVolumeMarkets
      }, function (err, marketsData) {
        if (err) {
          ...
          dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__update_has_loaded_markets__["a" /* updateHasLoadedMarkets */])(false));
        } else if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils_is_object__["a" /* default */])(marketsData) && Object.keys(marketsData).length) {
          dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__update_markets_data__["a" /* updateMarketsData */])(marketsData));
        }
      });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__filter_sort_container__ = __webpack_require__(1533);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_classnames__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_helpers_make_path__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_helpers_parse_query__ = __webpack_require__(727);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_helpers_parse_path__ = __webpack_require__(740);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_constants_views__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_constants_param_names__ = __webpack_require__(524);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__market_components_market_preview__ = __webpack_require__(1706);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_components_paginator__ = __webpack_require__(1540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_components_null_state_message__ = __webpack_require__(527);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_get_value__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_isEqual__ = __webpack_require__(729);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_isEqual___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_lodash_isEqual__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utils_debounce__ = __webpack_require__(91);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__markets_header__ = __webpack_require__(1715);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__markets_list__ = __webpack_require__(1716);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__branch_components_branch__ = __webpack_require__(1538);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_isEqual__ = __webpack_require__(729);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_isEqual___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_lodash_isEqual__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_helpers_parse_path__ = __webpack_require__(740);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_helpers_make_path__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__app_constants_views__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_constants_param_names__ = __webpack_require__(524);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
//# sourceMappingURL=markets.da377350e45054f61a22.js.map