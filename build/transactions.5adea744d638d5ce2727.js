...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_transactions_view__ = __webpack_require__(2218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__selectors_transactions__ = __webpack_require__(2070);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__auth_selectors_login_account__ = __webpack_require__(877);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__auth_actions_load_account_history__ = __webpack_require__(874);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__actions_trigger_transactions_export__ = __webpack_require__(2014);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__auth_actions_load_account_history__ = __webpack_require__(874);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectors_transactions__ = __webpack_require__(2070);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bignumber_js__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constants_types__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__constants_statuses__ = __webpack_require__(592);
...
var selectTransactions = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_reselect__["createSelector"])(__WEBPACK_IMPORTED_MODULE_3__select_state__["w" /* selectTransactionsDataState */], function (transactionsData) {
  var tradeGroups = [];
...
function formatGroupedTransactions(transactions) {
  ...
  var status = formattedTransactions.reduce(function (p, transaction) {
    if (p === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["a" /* FAILED */] || transaction.status === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["a" /* FAILED */]) return __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["a" /* FAILED */];
    if (p === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["b" /* INTERRUPTED */] || transaction.status === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["b" /* INTERRUPTED */]) return __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["b" /* INTERRUPTED */];
    if (p === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["c" /* PENDING */] || transaction.status === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["c" /* PENDING */]) return __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["c" /* PENDING */];
    if (p === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["d" /* SUBMITTED */] || transaction.status === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["d" /* SUBMITTED */]) return __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["d" /* SUBMITTED */];
    if (transaction.status === __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["e" /* SUCCESS */]) return __WEBPACK_IMPORTED_MODULE_5__constants_statuses__["e" /* SUCCESS */];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_transition_group_CSSTransitionGroup__ = __webpack_require__(593);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__transaction_details__ = __webpack_require__(2215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__transaction_summary__ = __webpack_require__(2217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_components_spinner__ = __webpack_require__(1956);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__constants_statuses__ = __webpack_require__(592);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              (p.status === __WEBPACK_IMPORTED_MODULE_7__constants_statuses__["d" /* SUBMITTED */] || p.status === __WEBPACK_IMPORTED_MODULE_7__constants_statuses__["c" /* PENDING */] || p.status === __WEBPACK_IMPORTED_MODULE_7__constants_statuses__["f" /* COMMITTING */]) && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__common_components_spinner__["a" /* default */], null)
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              'button',
              {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants_statuses__ = __webpack_require__(592);
...
var TransactionDetails = function TransactionDetails(p) {
  var TransactionDetails = function TransactionDetails(p) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      p.status === __WEBPACK_IMPORTED_MODULE_2__constants_statuses__["e" /* SUCCESS */] && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'transaction-detail' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'span',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_transition_group_CSSTransitionGroup__ = __webpack_require__(593);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_transition_group_CSSTransitionGroup___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react_transition_group_CSSTransitionGroup__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__transaction__ = __webpack_require__(2109);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_classnames__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_components_value_denomination__ = __webpack_require__(589);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_components_value_timestamp__ = __webpack_require__(893);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__my_reports_components_report_ethics__ = __webpack_require__(2013);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__constants_types__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__auth_constants_auth_types__ = __webpack_require__(2077);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__markets_constants_market_types__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_helpers_make_path__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__app_helpers_make_query__ = __webpack_require__(588);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils_get_value__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__app_constants_views__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__app_constants_param_names__ = __webpack_require__(587);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var TransactionSummary = function TransactionSummary(p) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    p.data.marketID ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      {
        to: {
          pathname: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__app_helpers_make_path__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_13__app_constants_views__["k" /* MARKET */]),
          search: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11__app_helpers_make_query__["a" /* default */])(_defineProperty({}, __WEBPACK_IMPORTED_MODULE_14__app_constants_param_names__["c" /* MARKET_ID_PARAM_NAME */], p.data.marketID))
        }
      },
...
function transactionAction(transaction) {
  var action = function action() {
    switch (transaction.type) {
      case __WEBPACK_IMPORTED_MODULE_8__auth_constants_auth_types__["a" /* FUND_ACCOUNT */]:
        return 'Fund Account ';
...
function transactionActionDetails(transaction) {
  switch (transaction.type) {
    ...
    case __WEBPACK_IMPORTED_MODULE_7__constants_types__["REVEAL_REPORT"]:
      {
        var type = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils_get_value__["a" /* default */])(transaction, 'data.market.type');
        var outcomeName = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__utils_get_value__["a" /* default */])(transaction, 'data.outcome.name');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__transactions__ = __webpack_require__(2219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__branch_components_branch__ = __webpack_require__(2002);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_components_paginator__ = __webpack_require__(2004);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_components_spinner__ = __webpack_require__(1956);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__transactions_loading_actions__ = __webpack_require__(2015);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utils_get_value__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__utils_debounce__ = __webpack_require__(115);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_transition_group_CSSTransitionGroup___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react_transition_group_CSSTransitionGroup__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__transaction__ = __webpack_require__(2109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__transaction_group__ = __webpack_require__(2216);
...
//# sourceMappingURL=transactions.5adea744d638d5ce2727.js.map