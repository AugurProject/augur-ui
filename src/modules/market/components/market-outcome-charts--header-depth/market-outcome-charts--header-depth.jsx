    ...
    <div className={Styles.MarketOutcomeChartsHeader__stats}>
      <span className={Styles.MarketOutcomeChartsHeader__stat}>
        ...
        <span className={Styles['MarketOutcomeChartsHeader__stat-value']}>
          {p.hoveredDepth[1] && p.hoveredDepth[1].constructor === WrappedBigNumber ? p.hoveredDepth[1].toFixed(p.fixedPrecision).toString() : <span>&mdash;</span>}
        </span>
      </span>
      <span className={Styles.MarketOutcomeChartsHeader__stat}>
        <span className={Styles[`MarketOutcomeChartsHeader__stat-title`]}>
        ...
        <span className={Styles[`MarketOutcomeChartsHeader__stat-value`]}>
          {p.hoveredDepth[2] && p.hoveredDepth[2].constructor === WrappedBigNumber ? p.hoveredDepth[2].toFixed(p.fixedPrecision).toString() : <span>&mdash;</span>}
        </span>
      </span>
      <span className={Styles.MarketOutcomeChartsHeader__stat}>
        <span className={Styles[`MarketOutcomeChartsHeader__stat-title`]}>
        ...
        <span className={Styles[`MarketOutcomeChartsHeader__stat-value`]}>
          {p.hoveredDepth[0] && p.hoveredDepth[0].constructor === WrappedBigNumber ? p.hoveredDepth[0].toFixed(p.fixedPrecision).toString() : <span>&mdash;</span>}
        </span>
      </span>
    </div>
  </section>
