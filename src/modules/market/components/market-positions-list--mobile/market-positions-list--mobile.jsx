      ...
      <section className={Styles.MarketPositionsListMobile}>
        ...
        {openOrders.length > 0 && (
          <div className={Styles["MarketPositionsListMobile__wrapper--orders"]}>
            <h2
              className={Styles["MarketPositionsListMobile__heading--orders"]}
            >
              Open Orders
            </h2>
            ...
            {s.showViewMore && (
              <button
                className={
                  Styles["MarketPositionsListMobile__orders-view-more"]
                }
                onClick={e =>
                  this.setState({
                    showViewMore: false,
                    visibleOrders: openOrders.length
                  })
                }
              >
                +View More
