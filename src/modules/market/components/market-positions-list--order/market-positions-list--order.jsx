        ...
        >
          { pending ?
            <div className={Styles['Order__confirm-details']}>
              <this.props>Orders cannot be closed while they are pending.</this.props>
              <div className={Styles['Order__confirm-options']}>
                <button onClick={this.toggleConfirm}>Ok</button>
              </div>
            </div> :
            <div className={Styles['Order__confirm-details']}>
              <this.props>Cancel order for { getValue(this.props, 'order.unmatchedShares.formatted') } shares of &ldquo;{ getValue(this.props, 'name') }&rdquo; at { getValue(this.props, 'order.purchasePrice.formatted') } ETH?</this.props>
              <div className={Styles['Order__confirm-options']}>
