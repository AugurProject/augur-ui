        ...
        >
          { openOrders.length > 0 ?
            <div className={Styles['Position__confirm-details']}>
              <this.props>Positions cannot be closed while orders are pending.</this.props>
            ...
            :
            <div className={Styles['Position__confirm-details']}>
              <this.props>Close position by selling { getValue(this.props, 'position.qtyShares.formatted') } shares of “{ getValue(this.props, 'name') }” at { getValue(this.props, 'position.avgPrice.formatted') } ETH?</this.props>
              <div className={Styles['Position__confirm-options']}>
