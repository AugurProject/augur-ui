...
const mergeProps = (sP: any, dP: any, oP: any) => ({
  ...
  description: [
    ...
    "Always make sure that the Market Question, Additional Details, Reporting Start Time, Resolution Source and Outcomes are not in direct conflict with eachother. Always make sure the market has mutually exclusive outcomes, i.e. only one outcome can occur.",
