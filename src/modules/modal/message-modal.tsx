...
import { ModalTitle, ModalDescriptionProps, ModalDescription, ModalButtonsRow, ModalAlertMessageProps, ModalAlertMessage, ModalMarketTitle, ModalCallToAction, LinearPropertyLabelProps, ModalBreakdown } from "modules/modal/common";
...
export const MessageModal = (props: MessageModalProps) =>
  <div className={Styles.MessageModal}>
    ...
    {props.callToAction && <ModalCallToAction callToAction={props.callToAction} />}
