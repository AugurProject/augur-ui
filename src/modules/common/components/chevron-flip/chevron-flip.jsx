    ...
    return (
      ...
      >
        ...
        >
          <g
            id="messages-stacked"
            transform="translate(-290.000000, -461.000000)"
            fill={p.stroke ? p.stroke : "#A7A2B2"}
            fillRule="nonzero"
          >
            <g id="Group-2" transform="translate(24.000000, 367.000000)">
              <g id="Group-5" transform="translate(189.000000, 91.000000)">
                <polygon
                  id="Triangle"
                  transform="translate(82.538462, 7.000000) scale(1, -1) translate(-82.538462, -7.000000) "
                  points="82.5384615 3 88.0769231 11 77 11"
                />
              </g>
            </g>
          </g>
