    ...
    >
      ...
      <li>
        {openOrder.unmatchedShares && (
          <ValueLabel keyId={"openOrder-unmatchedShares-"+openOrder.id} value={openOrder.unmatchedShares} />
        )}
      </li>
      <li>{openOrder.avgPrice && <ValueLabel keyId={"openOrder-price-"+openOrder.id} value={openOrder.avgPrice} />}</li>
      {extendedView && (
        <li>
          <ValueLabel keyId={"openOrder-tokens-"+openOrder.id} value={tokensEscrowed} />
        </li>
      )}
      {extendedView && (
        <li>
          <ValueLabel keyId={"openOrder-shares-"+openOrder.id} value={sharesEscrowed} />
        </li>
      )}
      <li>
              ...
              <div className={Styles.OpenOrder__info}>
                ...
                <div className={Styles.OpenOrder__labels}>
                  <LinearPropertyLabel
                    ...
                    value={tokensEscrowed.formatted || 0}
                  />
                  <LinearPropertyLabel
                    label="Total Cost (Shares)"
                    value={sharesEscrowed.formatted || 0}
                  />
