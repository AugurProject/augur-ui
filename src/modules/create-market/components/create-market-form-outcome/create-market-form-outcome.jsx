...
export default class CreateMarketOutcome extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      scalarMin: speedomatic.unfix(speedomatic.constants.INT256_MIN_VALUE).decimalPlaces(18, WrappedBigNumber.ROUND_DOWN),
      scalarMax: speedomatic.unfix(speedomatic.constants.INT256_MAX_VALUE).decimalPlaces(18, WrappedBigNumber.ROUND_DOWN),
    }
