          ...
          <div className={Styles.CreateMarketOutcome__scalar}>
            <div>
              ...
              <input
                ...
                min={s.scalarMin}
                max={s.scalarMax}
                value={newMarket.scalarSmallNum instanceof BigNumber ? newMarket.scalarSmallNum.toNumber() : newMarket.scalarSmallNum}
            ...
            <div>
              ...
              <input
                ...
                min={s.scalarMin}
                max={s.scalarMax}
                value={newMarket.scalarBigNum instanceof BigNumber ? newMarket.scalarBigNum.toNumber() : newMarket.scalarBigNum}
