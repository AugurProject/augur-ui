...
export default class CreateMarketReview extends Component {
  ...
  calculateMarketCreationCosts() {
    ...
    augur.createMarket.getMarketCreationCostBreakdown({ universe: universe.id, meta: meta }, (err, marketCreationCostBreakdown) => {
      ...
      <article className={StylesForm.CreateMarketForm__fields}>
        <div className={Styles.CreateMarketReview}>
          ...
          <div className={Styles.CreateMarketReview__resolution}>
            ...
            <this.props className={Styles.CreateMarketReview__smallparagraph}>
              {
          ...
          <div className={Styles.CreateMarketReview__addedDetails}>
            ...
            <this.props className={Styles.CreateMarketReview__smallparagraph}>{newMarket.detailsText || 'None'}</this.props>
          </div>
        </div>
      </article>
    );
