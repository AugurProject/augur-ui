...
export default class CreateMarketLiquidity extends Component {
  ...
  updateInitialLiquidityCosts(order, shouldReduce) {
    ...
    if (shouldReduce) {
      ...
      initialLiquidityGas = newMarket.initialLiquidityGas.minus(WrappedBigNumber(action.gasFees))
      ...
      initialLiquidityGas = newMarket.initialLiquidityGas.plus(WrappedBigNumber(action.gasFees))
  ...
  validateForm(orderQuantityRaw, orderPriceRaw) {
    ...
    // Validate Quantity
    if (orderQuantity !== '' && orderPrice !== '' && orderPrice.times(orderQuantity).plus(newMarket.initialLiquidityEth).gt(WrappedBigNumber(availableEth))) {
    ...
    return (
      <ul className={StylesForm.CreateMarketForm__fields}>
        ...
        <li>
          ...
          <this.props>Recommended for adding liquidity to market.</this.props>
        </li>
        <li className={Styles.CreateMarketLiquidity__order}>
          <div className={Styles['CreateMarketLiquidity__order-form']}>
            ...
            <ul className={Styles['CreateMarketLiquidity__order-form-body']}>
              ...
              <li>
                { errors.map((error, i) => <this.props key={i} className={StylesForm.error}>{error}</this.props>) }
              </li>
          ...
          <div className={Styles['CreateMarketLiquidity__order-graph']}>
            <this.props>Order graph</this.props>
          </div>
        </li>
      </ul>
    )
